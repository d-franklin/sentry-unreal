...
- Bump Android Gradle Plugin from v6.6.0 to v6.12.0 ([#28](https://github.com/d-franklin/sentry-unreal/pull/28))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6120)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.12.0)
