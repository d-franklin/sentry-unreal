...
- Bump Android Gradle Plugin from v6.6.0 to v6.20.0 ([#72](https://github.com/d-franklin/sentry-unreal/pull/72))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6200)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.20.0)
