...
- Bump Android Gradle Plugin from v6.6.0 to v6.18.0 ([#63](https://github.com/d-franklin/sentry-unreal/pull/63))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6180)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.18.0)
