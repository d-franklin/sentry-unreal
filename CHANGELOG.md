...
- Bump Android Gradle Plugin from v6.6.0 to v6.10.0 ([#20](https://github.com/d-franklin/sentry-unreal/pull/20))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6100)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.10.0)
