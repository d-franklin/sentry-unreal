...
- Bump Native SDK from v0.14.0 to v0.16.1 ([#60](https://github.com/d-franklin/sentry-unreal/pull/60))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0161)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.14.0...0.16.1)
