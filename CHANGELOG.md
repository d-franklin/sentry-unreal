...
- Bump Android Gradle Plugin from v6.6.0 to v6.14.0 ([#39](https://github.com/d-franklin/sentry-unreal/pull/39))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6140)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.14.0)
