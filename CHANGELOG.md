...
- Bump Native SDK from v0.14.0 to v0.15.2 ([#32](https://github.com/d-franklin/sentry-unreal/pull/32))
  - [changelog](https://github.com/getsentry/sentry-native/blob/master/CHANGELOG.md#0152)
  - [diff](https://github.com/getsentry/sentry-native/compare/0.14.0...0.15.2)
