...
- Bump Android Gradle Plugin from v6.6.0 to v6.15.0 ([#47](https://github.com/d-franklin/sentry-unreal/pull/47))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6150)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.15.0)
