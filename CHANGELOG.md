...
- Bump Android Gradle Plugin from v6.6.0 to v6.22.0 ([#81](https://github.com/d-franklin/sentry-unreal/pull/81))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6220)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.22.0)
