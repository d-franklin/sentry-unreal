...
- Bump Android Gradle Plugin from v6.6.0 to v6.11.0 ([#23](https://github.com/d-franklin/sentry-unreal/pull/23))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6110)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.11.0)
