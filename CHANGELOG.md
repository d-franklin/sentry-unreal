...
- Bump Android Gradle Plugin from v6.6.0 to v6.13.0 ([#35](https://github.com/d-franklin/sentry-unreal/pull/35))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6130)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.13.0)
