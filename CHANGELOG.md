...
- Bump Android Gradle Plugin from v6.6.0 to v6.21.0 ([#76](https://github.com/d-franklin/sentry-unreal/pull/76))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6210)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.21.0)
