...
- Bump Android Gradle Plugin from v6.6.0 to v6.16.0 ([#54](https://github.com/d-franklin/sentry-unreal/pull/54))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6160)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.16.0)
