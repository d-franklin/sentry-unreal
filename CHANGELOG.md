...
- Bump Crash Reporter from v0.2.0 to v0.3.3 ([#45](https://github.com/d-franklin/sentry-unreal/pull/45))
  - [changelog](https://github.com/getsentry/sentry-desktop-crash-reporter/blob/main/CHANGELOG.md#033)
  - [diff](https://github.com/getsentry/sentry-desktop-crash-reporter/compare/0.2.0...0.3.3)
