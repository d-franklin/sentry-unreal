...
- Bump Android Gradle Plugin from v6.6.0 to v6.19.0 ([#67](https://github.com/d-franklin/sentry-unreal/pull/67))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6190)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.19.0)
