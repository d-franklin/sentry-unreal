...
- Bump Android Gradle Plugin from v6.6.0 to v6.17.0 ([#59](https://github.com/d-franklin/sentry-unreal/pull/59))
  - [changelog](https://github.com/getsentry/sentry-android-gradle-plugin/blob/main/CHANGELOG.md#6170)
  - [diff](https://github.com/getsentry/sentry-android-gradle-plugin/compare/6.6.0...6.17.0)
